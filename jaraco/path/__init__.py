...
if TYPE_CHECKING:
    ...
    _StrOrBytesT = TypeVar('_StrOrBytesT', bytes, str)
...
def recursive_glob(
    root: GenericPath[_StrOrBytesT], spec: GenericPath[_StrOrBytesT]
) -> itertools.chain[_StrOrBytesT]:
    """
...
if TYPE_CHECKING:
    ...
    def tempfile_context(
        suffix: _StrOrBytesT | None = None,
        prefix: _StrOrBytesT | None = None,
        dir: GenericPath[_StrOrBytesT] | None = None,
        text: bool = False,
    ) -> Generator[_StrOrBytesT]: ...
...
def replace_extension(
    new_ext: _StrOrBytesT, filename: GenericPath[_StrOrBytesT]
) -> _StrOrBytesT:
    """
...
def ExtensionReplacer(
    new_ext: _StrOrBytesT,
) -> Callable[[GenericPath[_StrOrBytesT]], _StrOrBytesT]:
    """
